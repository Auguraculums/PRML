...
classdef DummyReaction < ReactionModel
    %DUMMYREACTION Represents a dummy reaction model doing nothing.
    %
    ...
    methods
        ...
        function obj = DummyReaction()
            %DUMMYREACTION Constructs a DummyReaction object
            obj.name = 'NONE';
            obj.parameters = [];
        end
